...
You can see the list of [available themes](https://github.com/lukilabs/beautiful-mermaid#built-in-themes) here.

## Examples

See the [Mermaid example](/examples/plugins/vue-vite-mermaid) for a complete working implementation.
...
- [Mermaid Themes](https://github.com/lukilabs/beautiful-mermaid)
