...
/**
 * Parse Comark content from a Node.js Readable stream or Web ReadableStream
 *
 * @param stream - A Node.js Readable stream or Web ReadableStream containing Comark content
 * @param options - Parser options
 * @returns Promise resolving to the parsed Comark structure
 *
 * @example
 * ```typescript
...
/**
 * Parse Comark content incrementally from a stream,
