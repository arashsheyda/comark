...
Math formula support for [comark](https://github.com/comarkdown/comark) using [KaTeX](https://katex.org/).
...
```bash
npm install @comark/math comark katex
# or
pnpm add @comark/math comark katex
# or
yarn add @comark/math comark katex
```
